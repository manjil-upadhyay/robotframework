...
test
    ...
    ...    Total Run Time:
    ...    00:06:22
    Selenium2Library.Open Browser    https://fleetmastr-temp.aecordigitalqa.com/login    ff
    sleep    3
    Selenium2Library.Go to    https://fleetmastr-temp.aecordigitalqa.com/login
    sleep    5
    Selenium2Library.Input Text    //input[@type="text"]    manjil.upadhyay
    sleep    3
    Selenium2Library.Input Text    //input[@type="password"]    12345678
    sleep    3
    Selenium2Library.Click Element    //*[@id="register-submit-btn"]
    sleep    5
    go to    https://fleetmastr-temp.aecordigitalqa.com/settings
    sleep    5
    Selenium2Library.Click Element    //*[@href="#accident_insurance"]
    sleep    3
    Selenium2Library.Input Text    //input[@name="insurance_company"]    ${InsuranceCompanyname}
    Set Global Variable    ${InsuranceCompanyname}
    Selenium2Library.Input Text    //input[@name="telephone_number"]    ${TelephoneNo}
    Set Global Variable    ${TelephoneNo}
    Selenium2Library.Input Text    //input[@name="policy_number"]    ${PolicyNo}
    Set Global Variable    ${PolicyNo}
    Selenium2Library.Input Text    //input[@name="policy_name"]    ${PolicyName}
    Set Global Variable    ${PolicyName}
    Comment    Selenium2Library.Click Element    //input[@name="insurance_file_input_name"]
    sleep    2
    Selenium2Library.Click Element    //button[@id="accident_insurance_submit"]
    sleep    2
...
Log into FM
    ...
    sleep    5
    AppiumLibrary.Input Text    ${AppUsernameXP}    mupadhyay+56@aecordigital.com
    sleep    3
    AppiumLibrary.Input Text    ${AppPasswordXP}    12345678
    sleep    3
...
Take out vehicle
    ...
    Sleep    2
    AppiumLibrary.Click Element    ${YesButton}
    Sleep    2
    AppiumLibrary.Click Element    ${Save_BTN}
    Sleep    3
    AppiumLibrary.Click Element    ${ResumevehicleCheck}
    Sleep    3
    AppiumLibrary.Click Element    ${YesButton}
    Sleep    2
    AppiumLibrary.Click Element    ${OptionNo}
    Sleep    2
    Click text    Hand cleaning station damaged
    Sleep    5
    AppiumLibrary.Click Element At Coordinates    517    1843
    Sleep    10
    AppiumLibrary.Click Element    ${OkayButton}
    Sleep    2
    Click Text    No
    Sleep    2
    ...
    Sleep    5
    AppiumLibrary.Click Element    ${CloseButton}
    Sleep    5
...
Verify Send mesage data by Admin user
    ...
    Go To    ${MessagesURL}
    sleep    8
    Selenium2Library.Click Element    ${MessageHistoryReportBTN}
    Sleep    4
...
Take out vehicle - with trailer (defect) (safe to operate)
    ...
    AppiumLibrary.Click Element    ${OptionYes}
    Sleep    2
    AppiumLibrary.Click Element    ${Option_No}
    Sleep    2
    AppiumLibrary.Click Element    ${id=com.aecor.fleetmastr:id/txt_defect_item}
    AppiumLibrary.Click Element    ${AllowCameraAccess}
    Sleep    2
    AppiumLibrary.Click Element    ${AllowCameraAccess}
    Sleep    2
