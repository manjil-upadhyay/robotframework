...
*** Keywords ***
Log into FM
    AppiumLibrary.Open Application    http://localhost:4723/wd/hub    platformName=Android    platformVersion=10    deviceName=192.168.0.103:5037    appPackage=com.aecor.fleetmastr.clhps    appActivity=com.aecor.fleetmastr.SplashActivity
    sleep    10
    AppiumLibrary.Input Text    com.aecor.fleetmastr.clhps:id/input_email    demo.ios
    sleep    3
    AppiumLibrary.Input Text    com.aecor.fleetmastr.clhps:id/input_password    password
    sleep    3
    Click text    Remember me
    sleep    3
    AppiumLibrary.Click Element    com.aecor.fleetmastr.clhps:id/btn_login
    Sleep    10
